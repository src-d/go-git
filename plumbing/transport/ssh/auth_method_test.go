...
var (
	_              = Suite(&SuiteCommon{})
	mockKnownHosts = []byte(`github.com ssh-rsa `)
)
...
func (*SuiteCommon) TestNewKnownHostsCallback(c *C) {
	...
	if hostKey == nil {
		c.Fatalf("no hostkey for %s", host)
	}
	...
	err = clb(host+":22", conn.RemoteAddr(), hostKey)
	c.Assert(err, IsNil)
}
